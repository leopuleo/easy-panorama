...
If you are using the Gutenberg editor, you will find the panorama block within the blocks list.
...
= 1.1.4 (03/10/2018) =
* Updated minimum Gutenberg version
* New deployment workflow via Travis CI
